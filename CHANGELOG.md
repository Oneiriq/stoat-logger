...
- NodeJS typing compatibility

### Added

- Dual publishing to both `jsr.io` and `npmjs.org`

## [1.1.0] - 2025-11-29

### Added

- NodeJS v18+ support for `@oneiriq/stoat-logger`
- NPM build script for deploying to npmjs

### Changed

- Moved project from `@albedosehen` to `@oneiriq` organization
- Created new jsr entry for organization `@oneiriq/stoat-logger`
